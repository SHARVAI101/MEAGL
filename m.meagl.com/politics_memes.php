...
<?php
	...
	echo '<button type="submit" onclick="memeCategorySubscribeFunction(0,\'Politics\',\''.$memeCategorySubscribersLabel.'\');" name="subscribecategoryPolitics" class="btn" id="userprofile-subscribe-button" style="margin: 5 auto;display:block;width:150px;position:relative">'.$subscribeToMemeCategoryInnerHtml.'</button>';
	echo '</div>';
?>
</div>
