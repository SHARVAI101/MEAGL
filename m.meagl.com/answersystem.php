		...
		if($_FILES['answerMeme']['size']!=0) {
			...
			if($file_size<6000000){//max file size is 6MB
				...
				if($ext == "jpg" || $ext == "png" || $ext == "jpeg" || $ext == "gif" ){
					...
					*/
                    ...
                    <?php 
                    if($filepath!=''){
                        echo '<img src="'.htmlentities($filepath).'" style="max-width:68vw"><br>';
                    }
                    ?>
                    <?php 
                    ...
                    <span class="numberOfReplies comment-info comment-replies" id="numberOfReplies<?php echo htmlentities($answerId); ?>" style="margin-left:0px">Replies: 0</span><br>
			...
			*/
			...
			<div class="answer_div comments-dedicated comments" id="answerdiv<?php echo htmlentities($answerId); ?>">
                ...
                <span class="likes comment-info" id="answerlikes<?php echo htmlentities($answerId); ?>" style="margin-left:0px">Likes: 0</span><br>
                <span class="numberOfReplies comment-info comment-replies" id="numberOfReplies<?php echo htmlentities($answerId); ?>" style="margin-left:0px">Replies: 0</span><br>
