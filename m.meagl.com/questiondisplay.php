...
if($numberOfFlags<5 && $flaggedByCurrentUser==false){
    ...
    echo '<div class="dedicated-question index-question-meme">';
     if(isset($_SESSION['id'])){
                if($_SESSION['id']==$askerId){
                    echo '<button type="submit" class="deletequestionbutton" name="'.htmlentities($questionId).'"><i class="fa fa-times" aria-hidden="true"></i></button>
                        ...
                        <p class="question-time"><i>- '.getTime($datetime).'</i></p>
                        ...
                        <h5 class="answers-count" id="'.htmlentities($numberOfAnswersLabel).'">'.htmlentities($numberOfAnswers).' answers</h5>
        ...
        if($displayFlagButton==true){
            ...
            echo '<a class="flagquestionbutton flag question-action" name="'.$questionId.'" id="questionFlagButton'.$questionId.'" >Downvote</a>';
    ...
    <div class="flag-message flag-question-message<?php echo $questionId; ?>" id="flag-question-message<?php echo $questionId; ?>" style="display:none">
        <p id="flag-p">Downvoting questions helps Meagl remove racist or pornographic content. Please don't downvote questions even if they are not good enough..They could be useful for someone else. You could tell us more about why you downvoted this meme:</p>
        <form class="flag-question-form" name="<?php echo $questionId; ?>" method="POST" action="">
    ...
    <form method="post" action="" enctype="multipart/form-data" id="answerform<?php echo htmlentities($questionId); ?>" name="answerform" style="width:100%;border-top:solid 1px #ccc;border-bottom:solid 1px #ccc">
        <div class="answer-form">
            ...
            <textarea class="form-control answer-text-area" rows="3" id="answer" name="answer" placeholder="Write an answer. You can either just write an answer or even attach an image if you wish to."></textarea><br>
            ...
            <div class="add-image-div">
                ...
                <input type="file" id="answerMeme" class="filestyle" data-buttonName="small-add btn" data-icon="false" data-buttonText="+" data-input="false" name="answerMeme" style="width:50px">
            </div>
        ...
        { 
            ...
            if($answerForQuestionId==$questionId){
                ...
                <div class="answer_div comments-dedicated comments" id="answerdiv<?php echo htmlentities($answerId); ?>">
                    ...
                    <span class="username" id="dedicated-username" style="position:relative;top:0px;"><?php echo $username; ?></span>
                    <span class="answer" id="answer<?php echo htmlentities($answerId); ?>" contenteditable="false"><?php echo $answer; ?>
                    <br>
                    <?php 
                    if($answerMemelocation!=''){
                        echo '<img src="../'.$answerMemelocation.'" style="max-width:68vw"><br>';
                    }
                    ...
                    <span class="likes comment-info" id="answerlikes<?php echo htmlentities($answerId); ?>" style="margin-left:0px">Likes: <?php echo $likes; ?></span><br>
                    <span class="numberOfReplies comment-info comment-replies" id="numberOfReplies<?php echo htmlentities($answerId); ?>" style="margin-left:0px">Replies: <?php echo $numberOfReplies; ?></span><br>
                    ...
                    {
                        echo '<a class="likeanswerbutton action-link like-link-answer" onclick="answerlikeFunction(\''.htmlentities($answerId).'\',\''.htmlentities($answerlikesLabel).'\');" id="answerlike'.htmlentities($answerId).'" name="'.htmlentities($answerId).'">'.$answerlikesinnerhtml.'</a><br>';  
                        //shows/hides reply button on clicking
                        echo '<a class="showanswerreplyformbutton action-link reply-link-answer" name="'.htmlentities($answerId).'" style="margin-left:73px">Reply</a></p>';
                    }
                    if(isset($_SESSION['id'])){
                    ...
                    echo '<form method="post" class="answerreplyform" id="answerreplyform'.htmlentities($answerId).'" action="" style="display:none">
                            ...
                            <div class="add-image-div">
                                <p class="add-image-header" style="margin-top:15px">Add Image: </p>
                                <input type="file" id="answerReplyMeme" class="filestyle" data-buttonName="reply-small-add btn" data-icon="false" data-buttonText="+" data-input="false"  name="answerReplyMeme">
                            </div>
                    ...
                    if($numberOfReplies>=1){
                        ...
                        { 
                            ...
                            if($replyToAnswerId==$answerId){
                                ...
                                echo '
                                    <div class="answerreply_div reply-comment" id="'.htmlentities($replydivname).'">
                                ...
                                if($answerReplyMemelocation!=''){
                                    echo '<img src="../'.$answerReplyMemelocation.'" style="max-width:68vw;"><br><br>
                                        ';
                                }
                                echo '
                                ...
                                echo '<p id="answerreplyLikeError'.htmlentities($replyId).'" class="error-message"></p>';
                                echo '</div>';    
