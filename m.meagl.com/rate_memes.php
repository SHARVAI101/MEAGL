...
<br>
<br>
<h1 class="develop-text" style="font-size:35px">RATE MEMES</h1>
<p class="develop-text" style="font-size:17px">Welcome to the Meagl Meme Rating System! Here, you can rate memes according to your liking and view the average scores of memes that are calculated according to other peoples' ratings. We decided to make this system thanks to Pewdiepie's idea in one of his videos! Thanks Papa Pewds :)</p>
<hr>
<?php
...
while($row=mysqli_fetch_assoc($result)){
    ...
    <div class="meme centering" style="display:block;margin:25px auto 0px auto">
        <h2 class="title"><b><?php echo $meme_name ?></b></h2>
        <p class="points open-sans" style="display:block">Score: <span id="score_span<?php echo $memeId; ?>"><?php echo $score; ?></span></p>
        ...
        ?>
        <div style="border:1px solid #cccccc;margin:0 8px 35px 8px;border-radius:5px">
            <p class="title" style="margin-top:0px;font-size:18px">Rate This Meme :</p>
            <?php
