...
<p class="develop-text">Have any suggestions, feedback, business queries or have found some bugs? Feel free to mail us at <span style="color:#b522a8">support@meagl.com</a></p>
<?php
if(!isset($_SESSION['id'])){
?>
<p class="develop-sign-in" style="margin-top:30px"><a href="signup.php">Not signed in yet? Sign in now!</a></p>
<?php
}
?>
