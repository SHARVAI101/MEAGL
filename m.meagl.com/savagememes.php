...
<?php
	...
	echo '<button type="submit" onclick="memeCategorySubscribeFunction(0,\'Savage\',\''.$memeCategorySubscribersLabel.'\');" name="subscribecategorySavage" class="btn" id="userprofile-subscribe-button" style="margin: 5 auto;display:block;width:150px;position:relative">'.$subscribeToMemeCategoryInnerHtml.'</button>';
	echo '</div>';
?>
</div>
