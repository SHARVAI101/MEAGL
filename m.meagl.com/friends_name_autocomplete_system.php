...
if(isset($_POST['friend_name']))
{
	...
	if(isset($un)){
		foreach($un as $u){
			...
			{
				$suggestion.= '<label class="checkbox" style="margin-left:-10px;margin-top:10px;"><input type="checkbox" class="groupInviteCheckbox" name="new_group_user_ids[]" value="'.$fid.'">'.$fname.'</label><hr>';
			}
		}
	}
