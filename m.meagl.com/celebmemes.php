...
<?php
	...
	echo '<button type="submit" onclick="memeCategorySubscribeFunction(0,\'Celeb\',\''.$memeCategorySubscribersLabel.'\');" name="subscribecategoryCeleb" class="btn" id="userprofile-subscribe-button" style="margin: 5 auto;display:block;width:150px;position:relative">'.$subscribeToMemeCategoryInnerHtml.'</button>';
	echo '</div>';
?>
</div>
