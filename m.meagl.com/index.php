...
if(isset($_SESSION['id'])){
	...
	<div class="index-group-display" >
		...
		if (!empty($all_sharing)) {
			...
			echo '<div class="scrollable" style="white-space: nowrap;width:100%;margin:0 auto;display:block;left:0px">';
...
if(isset($_SESSION['id'])){
	?>
	<div class="tabs">
		<a id="recommendedmemes" href="#recommended" class="highlight-tab a-tab">Recommended</a>
		<a id="trendingmemes" href="#trending" class="background-tabs a-tab">Trending</a>
		<a id="freshmemes" href="#fresh" class="background-tabs a-tab">Fresh</a>	
		<a id="shuffle" href="#shuffled" class="background-tabs a-tab">Shuffle</a>
<?php
}else{
	?>
	<div class="tabs sign-out-tabs">
		<a id="trendingmemes" class="sign-out-trend highlight-tab a-tab" href="#trending" style="border-radius:3px;top:3.5px;">Trending</a>
		<a id="freshmemes" class="sign-out-fresh sign-out-background-tabs a-tab" href="#fresh" style="border-radius:3px;top:3.5px">Fresh</a>	
		<a id="recommendedmemes" class="sign-out-recom sign-out-background-tabs a-tab" href="#recommended" style="border-radius:3px;top:3.5px;">Recommended</a><!--latest changes here.......latest changes end-->
...
<div class="tab-content" id="tabs"> 
	...
	{//style this boi
		?>
		<div class="tab recommendedmemes" id="recommended" style="width:100%">
			<div class="signed-out-recom-message">
				<?php
