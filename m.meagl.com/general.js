...
/////////////////////////////////////////////////////////////////////////////////
//opening mobile options
$(document).ready(function(){
    $('body').on('click','.mobi-wrapper',function(e){
        $(".mobi-options").toggle();
    });
});
/////////////////////////////////////////////////////////////////////////////////
    ...
    if(input.files && input.files[0]){
        ...
        reader.onload = function(e) {
            ...
            $("#previewImage").on('load', function(){
                //once the preview image has loaded in 
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if(Ajaxresponse=="login error"){
                ...
                for(i = 0; i < subscribeElements.length; i += 1){
                    ...
                    subscribeElements[i].style.letterSpacing="1px";
        ...
        formData.append("numberOfRepliesActual",numberOfRepliesActual);//attaching numberOfAnswersActual variable to the form data
            ...
            ({
                ...
                success: function (response) 
                {
                    ...
                    if(response.trim()=="wrong file type"){
                    ...
                    else if(response.trim()=="no reply"){
                        document.getElementById("answerreplyerror"+answerId).innerHTML="Reply not entered!";
                    }
                    else{
                        $("#answerreplyerror"+answerId).hide();
                        ...
                        //alert("answer reply response="+response);
                        document.getElementById(numberOfRepliesname).innerHTML="Replies:"+(numberOfRepliesActual+1);
                        ...
                        for(var j=0;j<elements.length;j++)
                        {
                            if(friend_invites_array[i]==elements[j].value)
                            {
                                ...
                                {   //alert("checked");
                                    ...
                                    //alert("friend_hr"+elements[j].value);
                                    $("#friend_hr"+elements[j].value).remove();
                                }
                            }
                        }
...
$(document).ready(function(){
    //alert(sessionId);
    var changeGroupPicForm=false;
    $('body').on('click', '#finalChangeButton', function(e){ 
        e.preventDefault();
        changeGroupPicForm=true;
        $(".updateGroupPicForm").submit();
    });
    ...
    $(".updateGroupPicForm").submit(function(e){ 
        ...
        if(changeGroupPicForm==true)
        {
            changeGroupPicForm=false;
            $.ajax
            ({
                type: 'POST',
                ...
                success: function (response) 
                {
                    ...
                    if(response.trim()==="no file selected"){
                        ...
                        document.getElementById("updateGroupPicError").innerHTML="Group D.P. successfully changed!";                        
...
$(document).ready(function(){
    $("#signup-form-open-button").click(function(){
        $("#signup-form-div").slideToggle();
    });
});
...
$(document).ready(function(){
    $("#login-form-open-button").click(function(){
        $("#login-form-div").slideToggle();
    });
});


//open close "right-part" on user profile
$(document).ready(function(){
    $("#more-info-chevron").click(function(){
        $(".right-part").slideToggle();
    });

    /*var offsetHeight = document.getElementById('right-part').offsetHeight;
    document.getElementById('right-part').style.height = offsetHeight+'px';*/
    var h=$(".right-part").height();
    $(".right-part").css("height", h);
});

//open close "group-lower" on groupspage
$(document).ready(function(){
    $("#more-group-info-chevron").click(function(){
        $(".group-lower").slideToggle();
    });
...
//seetting height of right-part div on userprofile page dynamically
$(document).ready(function(){
    var h=$(".right-part").height();
    $(".right-part").css("height", h);
});

//slide toggle my friends
$(document).ready(function(){
    $("#show-friends-chevron").click(function(){
        $(".all_friends_div").slideToggle();
    });
});

//to align number of subscribers on userprofile page properly
$(document).ready(function(){
    console.log(window.location.pathname);
    if(window.location.pathname=='/m.meagl.com/userprofile.php'){   //make this /userprofile.php in upload wala js         
        
        var getnumber=(document.getElementById("subscribers0").innerHTML).match(/\d+$/);//gets the number at the end of the string and then stores it in the zeroth position of an array
        if(getnumber){
            var ns = parseInt(getnumber[0]);//converts the number which is stored in the form of string to an integer
        }   
        //alert(ns);

        if(ns<10)
        {
            document.getElementById('user-subs-div').setAttribute("style","width:140px");
        }
        else if(ns>=10 && ns<100)
        {
            document.getElementById('user-subs-div').setAttribute("style","width:160px");
        }
        else  if(ns>=100 && ns<1000)
        {
            document.getElementById('user-subs-div').setAttribute("style","width:180px");
        }
        else  if(ns>=1000 && ns<10000)
        {
            document.getElementById('user-subs-div').setAttribute("style","width:200px");
        }
   }
   else if(window.location.pathname=='/m.meagl.com/imagedisplay.php'){   //make this /userprofile.php in upload wala js         
        
        //for user subscribers
        var getnumber=($(".dedicated-meme-sub-btn").html()).match(/\d+$/);//gets the number at the end of the string and then stores it in the zeroth position of an array
        if(getnumber){
            var ns = parseInt(getnumber[0]);//converts the number which is stored in the form of string to an integer
        }   
        //alert(ns);
        ...
        //for category subscribers
        var getnumber1=($(".meme-categ-sub-btn").html()).match(/\d+$/);//gets the number at the end of the string and then stores it in the zeroth position of an array
        if(getnumber1){
            var nsa = parseInt(getnumber1[0]);//converts the number which is stored in the form of string to an integer
        }   
        //alert(nsa);
        if(nsa<10)
        {
            //alert("herer");
            document.getElementById('categ-subs-div').setAttribute("style","width:140px");
        }
        else if(nsa>=10 && nsa<100)
        {
            document.getElementById('categ-subs-div').setAttribute("style","width:160px");
        }
        else  if(nsa>=100 && nsa<1000)
        {
            document.getElementById('categ-subs-div').setAttribute("style","width:180px");
        }
        else  if(nsa>=1000 && nsa<10000)
        {
            document.getElementById('categ-subs-div').setAttribute("style","width:200px");
        }
   }
});
/*
$(document).ready(function(){
    ...
    if(window.location.pathname=='/m.meagl.com/userprofile.php'){   //make this /userprofile.php in upload wala js         
        ...
        var getnumber=(document.getElementById("user-info-subscribed").innerHTML).match(/\d+$/);//gets the number at the end of the string and then stores it in the zeroth position of an array
        if(getnumber){
            var ns = parseInt(getnumber[0]);//converts the number which is stored in the form of string to an integer
        }   
        //alert(ns);
        ...
        if(ns<10)
        {
            document.getElementById('user-info-subscribed').setAttribute("style","width:160px");
        }
        else if(ns>=10 && ns<100)
        {
            document.getElementById('user-info-subscribed').setAttribute("style","width:185px");
        }
        else  if(ns>=100 && ns<1000)
        {
            document.getElementById('user-info-subscribed').setAttribute("style","width:200px");
        }
   }
});*/
...
$(document).ready(function(){
    ...
    $('#notifications').click(function(){
        $('.notif').removeClass('addBackground');
        $('.notifications-column').slideToggle(900);
    });
    ...
    $('#recommendedmemes').click(function(){
        ...
        ctx.fillStyle="#b522a8";
        ctx.fill();*/
        $(this).addClass("highlight-tab");
        $(this).removeClass("background-tabs");

        $('#trendingmemes').removeClass('highlight-tab');
        $('#freshmemes').removeClass('highlight-tab');       
        $('#shuffle').removeClass('highlight-tab');

        $('#trendingmemes').addClass('background-tabs');
        $('#freshmemes').addClass('background-tabs');
        $('#shuffle').addClass('background-tabs');
        ...
        $(".sign-out-recom").removeClass('sign-out-background-tabs');
        $(".sign-out-recom").addClass('highlight-tab');
        $('.sign-out-trend').removeClass('highlight-tab');
        $('.sign-out-trend').addClass('sign-out-background-tabs');
        $('.sign-out-fresh').removeClass('highlight-tab');
        $('.sign-out-fresh').addClass('sign-out-background-tabs');
    });
    ...
    $('#trendingmemes').click(function(){
       ...
       /* ctx.clearRect(0,0,canvas.width,canvas.height);
        ...
        $('#recommendedmemes').removeClass('highlight-tab');
        $('#freshmemes').removeClass('highlight-tab');
        $('#shuffle').removeClass('highlight-tab');

        $('#recommendedmemes').addClass('background-tabs');
        $('#freshmemes').addClass('background-tabs');
        $('#shuffle').addClass('background-tabs');
       ...
       // $('.sign-out-fresh').css({'color':'#aaa'});
        ...
        $(".sign-out-trend").removeClass('sign-out-background-tabs');
        $(".sign-out-trend").addClass('highlight-tab');
        $('.sign-out-recom').removeClass('highlight-tab');
        $('.sign-out-recom').addClass('sign-out-background-tabs');
        $('.sign-out-fresh').removeClass('highlight-tab');
        $('.sign-out-fresh').addClass('sign-out-background-tabs');
    });
    ...
    $('#freshmemes').click(function(){
        ...
        $(".sign-out-fresh").removeClass('sign-out-background-tabs');
        $(".sign-out-fresh").addClass('highlight-tab');
        $('.sign-out-recom').removeClass('highlight-tab');
        $('.sign-out-recom').addClass('sign-out-background-tabs');
        $('.sign-out-trend').removeClass('highlight-tab');
        $('.sign-out-trend').addClass('sign-out-background-tabs');
    ...
    $("[type=text].search").focusin(function(){
        ...
        //document.getElementById("search-text").innerHTML="search users";
        $("#search-text").attr("placeholder", "search users");
    });
    ...
    $("[type=text]").focusout(function(){
        ...
        $("#search-text").attr("placeholder", "Q");
    });
    ...
    if(title=="Savage"||title=="College / School"||title=="Sports"||title=="Celeb"||title=="Gaming"||title=="Comic"||title=="Politics"||title=="Just My Thoughts"||title=="Other")
    {
        ...
        //$('.sign-out-fresh').css({'color':'#aaa'});
        $('#trendingmemes').click(function(){
            $(this).addClass('sign-out-class');
            $(this).addClass('highlight-tab');
            $(this).removeClass('sign-out-background-tabs');
            //$('.sign-out-fresh').css({'color':'#aaa'});
            $('#freshmemes').removeClass("sign-out-class");
            $('#freshmemes').removeClass("highlight-tab");
            $('#freshmemes').addClass("sign-out-background-tabs");
            //$(this).css({'color':'#666'});
        });
        $('#freshmemes').click(function(){
            $(this).addClass('sign-out-class');
            ...
            $(this).removeClass('sign-out-background-tabs');
            //$('.sign-out-trend').css({'color':'#aaa'});
            $('#trendingmemes').removeClass("sign-out-class");
            $('#trendingmemes').removeClass("highlight-tab");
            $('#trendingmemes').addClass("sign-out-background-tabs");
            //$(this).css({'color':'#666'});
        });
        /*var tOffset=$('.tabs').offset().top;
            var sHeight=$('.tabs').height()+10;
    ...
    $('#memes-tab').click(function(evt){
        ...
        $('#memes-tab').removeClass('background-tabs');
        $('#memes-tab').addClass('highlight-tab');
        $('#subscriptions-tab').removeClass('highlight-tab');
        $('#subscriptions-tab').addClass('background-tabs');
        $('#social-tab').removeClass('highlight-tab');
        $('#social-tab').addClass('background-tabs');

        $('html, body').animate({scrollTop: $("#more-info-chevron").offset().top},0);
    });
    ...
    $('#subscriptions-tab').click(function(evt){
        ...
        $('#memes-tab').removeClass('highlight-tab');
        $('#memes-tab').addClass('background-tabs');
        $('#subscriptions-tab').removeClass('background-tabs');
        $('#subscriptions-tab').addClass('highlight-tab');
        $('#social-tab').removeClass('highlight-tab');
        $('#social-tab').addClass('background-tabs');
       // $(this).addClass('border');
        ...
        //SUBSCRIPTIONS TAB INNER CONTENT
    ...
    $('#social-tab').click(function(evt){
        ...
        $('#subscriptions-tab').removeClass('highlight-tab');
        $('#subscriptions-tab').addClass('background-tabs');
        $('#social-tab').removeClass('background-tabs');
        $('#social-tab').addClass('highlight-tab');
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(title=="Settings"){
        ...
        $('#update-pic').click(function(){     
            ...
            {
                $('.prof-pic-update').hide();
                $(this).removeClass('current-link no-border');
            }
            else{          
                $('.change-password').hide();
                $('.update-status').hide();
                ...
                $(this).addClass('current-link no-border');
                $('#update-stat').removeClass('current-link no-border');
                $('#change-pass').removeClass('current-link no-border');
                $('#select-lang').removeClass('current-link no-border');
            }
        ...
        $('#change-pass').click(function(){
            if($(this).hasClass("current-link"))       
            {
                ...
                $(this).addClass('current-link no-border');
                $('#update-stat').removeClass('current-link no-border');
                $('#update-pic').removeClass('current-link no-border');
                $('#select-lang').removeClass('current-link no-border');
            }
        });
        $('#update-stat').click(function(){
    ...
    if(title=="Upload Meme"){
        ...
        $('body').on('click','#rules-heading',function(e){
            e.preventDefault();
            //if(window.)
            //alert("click wa");
