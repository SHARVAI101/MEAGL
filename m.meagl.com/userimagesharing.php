...
//background-color:#590755;
echo '<div style="background-color:#fff;margin-top:-30px">';
echo '<h1 class="userprofile-tab-heading" style="margin-top:90px;width:270px;font-size:27px;color:#CEB250;padding-top:10px"><b>PERSONAL   SHARING</b></h1>';
//echo '<hr style="margin-bottom:-3px">';
echo '<div class="user-share">

		<a href="userprofile.php?id='.$userId.'">
			<img src="../'.$ppL.'" style="width:50px;height:50px;margin-left:10px;margin-top:10px;border-radius:50%">
			<h4 class="group-name" id="user-share-username" style="margin-left:10px;top:15px;display:inline;font-size:20px;color:#000000;color:#CEB250;position:absolute;"><b>'.$uname.'</b></h4>			
		</a>';
echo '</div>';
echo '</div>';
echo '<hr>';
echo '<div class="right-container" style="width:100%;margin-top:0px">';
