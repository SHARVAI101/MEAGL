...
if($email!="" && $pwd!=""){
	...
	if(!$row=mysqli_fetch_assoc($result)){
		...
		//if(password_verify($pwd, $db_pwd)) {
			...
			/*$time=60*60*24 * 365 * 10; // this is in seconds 86400 = 1 day...86400*365=365 days *10 = 10 years xD
			...
			setcookie('profilePictureLocation', $row['profilePictureLocation'], time() + $time, "/");*/
