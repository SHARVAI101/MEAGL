...
<head>
    ...
    jax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>-->
	    ...
	    <div class="login-wrapper">
	      	<div class="login">
	      		<form class="loginForm" action="loginh.php" method="POST">
					...
					?>
					<button class="inbutton btn login-button" id="loginbutton" type="submit"><b>Sign in</b></button>
				</form>
				<p id="logInError"></p>
...
<div class="signup">
	...
	<form class="signupForm" action="signuph.php" method="POST">
		...
		?>
		<button class="inbutton btn signup-button" id="signupbutton" type="submit"><b>Sign up</b></button>
	</form>
	<p id="signInError"></p>
</div>
<?php
