...
if(isset($_SESSION['id'])){
	...
	<div class="tabs">
		...
		<a id="trendingmemes" class="sign-out-trend" href="#trending" style="color: #aaa;border-radius:3px;top:3.5px;left:125px">Trending</a>
		<a id="freshmemes" class="sign-out-fresh" href="#fresh" style="color: #aaa;border-radius:3px;top:3.5px;left:100px">Fresh</a>	
