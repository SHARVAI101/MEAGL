...
<body>	
    ...
    <div class="top-nav container-fluid" style="/*background-color:#131313;*/top:5px;">
        <nav>
            <?php
            ...
            <!--
            <div class="dropdown">
                <p id="dropdown" style="cursor:pointer;color:#b225a8">
            ...
            <div class="search-box" id="search-box">
                <form class="searchBarForm">
                    <input type="text" placeholder="Search users" class="search form-control" style="font-size:20px;color:#">                   
                </form>
            ...
            <div class="wrapper">
                ...
                <?php
                    ...
                    if($current_page=='/meagl.com/signup.php?lastpage=uploadmeme.php'){
                        ...
                        //echo $current_page;
                        echo '<li style="display:inline" class="error-message">
                        <a href="signup.php"><b>Sign In / Sign Up </b></a></li>';
                    }
                }
                ?>
                ...
                <div class="q">
                    <a href="memedevelopersforum.php" class="q-link q-header" style="color:black"><span>Q</span></a>
                </div>
            </div>
        ...
        ?>
    <!--
    <div class="header2" style="background-color:#b225a8">
      	<a href="index.php" class="categ-link"><h1 class="categ">All</h1></a>
        <a href="rate_memes.php" class="categ-link"><h1 class="categ">Rate Memes (NEW)</h1></a>
