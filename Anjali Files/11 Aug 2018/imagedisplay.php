		...
		<div class="right-container">
			<div class="posters-plate">
				<h1 class="username" style="top:0px;left:130px"><a href="userprofile.php?id=<?php echo $uploaderId; ?>"><?php echo $uploader; ?></a></h1>
   				...
   				<h1 class="info-subscribers" id="<?php echo $subscribeLabel; ?>" name="<?php echo $subscribeLabel; ?>" style="top:50px;left:307px;"><?php echo $numberofSubscribers; ?></h1>
			...
			<div class="category-plate">
				<img src="<?php echo $categoryImageSource; ?>" class="category-dp">
		   		...
		   		<?php 
		   		echo '<button type="submit" onclick="memeCategorySubscribeFunction(\''.$imageId.'\',\''.$memecategory.'\',\''.$memeCategorySubscribersLabel.'\');" name="subscribecategory'.$memecategory.'" class="btn" id="userprofile-subscribe-button" style="top:120px;left:180px;">'.$subscribeToMemeCategoryInnerHtml.'</button>';
		   		?>  		
   			</div>
...
<div class="small-notifications-column">
    ...
    ?>
		...
		<button type="submit" class="tip-btn">Drop a Tip</button><br><br>
			<div class="encourage-memer" style="overflow:scroll;overflow-x:hidden;overflow-y:scroll;">


   					<h1 style="font-size:22px;text-align:left;margin-left:20px">Tips:</h1>
   					<hr style="border-color:#cccccc">
   					<a href="#" style="text-align:center;margin-left:110px;font-size:20px;margin-top:300px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/anjali.jpg">Anjali<p style="margin-left:60px;display:inline;color:#b225a8">$1000</p></a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$900</p></a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px;margin-top:300px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/anjali.jpg">Anjali<p style="margin-left:60px;display:inline;color:#b225a8">$800</p></a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$700</p>   </a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px;margin-top:300px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/anjali.jpg">Anjali<p style="margin-left:60px;display:inline;color:#b225a8">$600</p></a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$500</p>   </a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$500</p>   </a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$500</p>   </a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$500</p>   </a><br><br><br>
    				<a href="#" style="text-align:center;margin-left:110px;font-size:20px"><img style="position:absolute;left:60px;height:35px;width:35px;border-radius:50%" src="defaults/sharvai.jpg">Sharvai<p style="margin-left:42px;color:#b225a8;display:inline">$500</p>   </a><br><br><br>
