    ...
    $(".load_more_memes_form").submit(function(e){ 
        ...
        ({
            ...
            success: function (response) 
            {
                ...
                else if(formtype=="index_page_trending_loadmore_form" || formtype=="savage_page_trending_loadmore_form"){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if(Ajaxresponse=="login error"){
                ...
                for ( i = 0; i < elements.length; i += 1) {
                    ...
                    /*if(Ajaxresponse>1000){
                        elements[i].style.width=52;
                        elements[i].style.letterSpacing=-0.05;
                        elements[i].innerHTML = (parseInt(Ajaxresponse/100))/10+'k';
                    }
                    else if(Ajaxresponse>=100)
                    {
                        elements[i].style.width=72;
                    }
                    else if(Ajaxresponse<100&&Ajaxresponse>=10)
                    {
                        elements[i].style.width=62;
                    }
                ...
                for(i = 0; i < subscribeElements.length; i += 1){
                    ...
                    subscribeElements[i].style.backgroundColor="3a3a3a";
                    subscribeElements[i].style.left="75px";
                ...
                for(i = 0; i < subscribeElements.length; i += 1){
                    ...
                    /*subscribeElements[i].style.color="white";
                    subscribeElements[i].style.backgroundColor="black";*/
                    /////////////////////////////////////////
                    /*$(subscribeElements[i]).css({
                        letter-spacing: '0px';
                    });*/
                    subscribeElements[i].style.backgroundColor="#444";
                    subscribeElements[i].style.left="67px";
                    subscribeElements[i].style.letterSpacing="0.1px";
