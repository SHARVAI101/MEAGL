...
if(isset($_SESSION['id'])){
	...
	<form action="" id="uploadmemeform<?php echo $userId; ?>" method="post" enctype="multipart/form-data" class="upload-form">
        ...
        <div class="image upload-image-div">
       		<input type="file" id="meme" name="meme" class="filestyle" data-buttonName="upload-btn btn" data-icon="false" data-buttonText="+" data-input="false">
        </div>
		...
		<div class="upload-part-2">
			<h4 class="select-header">Select who do you want to share this meme with!</h4>
			...
			<div class="checkbox group-select">
			<label class="select-label group-header-label"><input type="checkbox" class="allFriendsVisibiltyCheckbox memeSharingCheckbox"><p class="allFriendsCheckboxLabel">All of My Friends</p></label><hr style="margin-top:5px;margin-bottom:0px;border-color:#cccccc;">
			<div class="checkbox lower-group-select">
			<?php
			//make friends div
			...
			<hr>
			<textarea name="memedescription" rows="3" placeholder="Enter meme description. No one is ever going to read it." class="meme-description form-control"></textarea><br><br>
