    ...
    <div class="rules">
        ...
        <ul style="padding-left:0px">
            ...
            <li class="rule">
                ...
                <div class="full-rule">
                    We have strict guidelines against pornographic content or nudity. Any user posting content that is pornographic in nature will face sticter regulations on any content posted by him/her in the future.
                </div>
                <hr style="margin-top:20px;margin-bottom:0px">
            </li>
            <li class="rule">
