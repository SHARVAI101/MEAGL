...
?>
	...
	<div class="tabs" id="home-page-tabs">
		<a href="#memes" id="memes-tab" style="padding-bottom:4px">Memes</a>
		<a href="#subscribedcontent" id="subscriptions-tab" style="padding-bottom:4px">Subscriptions</a>
		<a href="#sociallife" id="social-tab" style="padding-bottom:4px">Social Life</a>
	<?php
	}
	else{
		if(isset($_SESSION['id']))
...
<?php
	if((isset($_GET['id']) && isset($_SESSION['id']) && $_GET['id']==$_SESSION['id'])){
		//only visible if the user is viewing his own profile
	?>
	<a id="notif-tab">Notifications<span class="notif-num" id="notificationsNumberUP" style="display:none;"></span></a>
	<?php
	}
	else
	{
