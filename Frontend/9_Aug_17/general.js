...
//post upload changes in this block
function thereAreNotifications(notificationsNumber){
    //alert(notificationsNumber);
    document.getElementById("notificationsNumber").style.display="inline";
...
function thereAreNotificationsUP(notificationsNumber){
    ...
    document.getElementById("notificationsNumberUP").style.display="inline";
    
    document.getElementById("notificationsNumberUP").innerHTML=""+notificationsNumber
}
//post upload changes end
///////////////////////////////////////////////////////////////////////////////////////
            ...
            ({
                ...
                {     
                    if(response=="success"){
                        ...
                        //post upload changes:test this line!-->$(".final-flag-message"+imageId).fadeOut(2000);
                    }        
                },                
                error: function(xhr, status, error) {
                    alert(xhr.responseText);
