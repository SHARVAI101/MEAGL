$(document).ready(function(){
	...
	ctx.beginPath();
		ctx.rect(0,4,$('#hotmemes').width()+13,canvas.height);
		ctx.rect(0,0,3,canvas.height);
		ctx.rect($('#hotmemes').width()+13,0,canvas.width,canvas.height);
	...
	$('#hotmemes').click(function(){
		...
		ctx.beginPath();
		ctx.rect(0,4,$(this).width()+13,canvas.height);
		ctx.rect(0,0,3,canvas.height);
		ctx.rect($(this).width()+13,0,canvas.width,canvas.height);
		ctx.fillStyle="#b522a8";
		ctx.fill();
		$('#hotmemes:after').show();
		$('.hotmemes').show();
	...
	$('#trendingmemes').click(function(){
		...
		ctx.clearRect(0,0,canvas.width,canvas.height);
		ctx.beginPath();
		ctx.rect($('#hotmemes').width()+76,4,$(this).width()+19,canvas.height);
		ctx.rect(0,0,$('#hotmemes').width()+76,canvas.height);
		ctx.rect($('#hotmemes').width()+23,0,3,canvas.height);
		ctx.rect($('#hotmemes').width()+$(this).width()+87,0,canvas.width,canvas.height);
		ctx.fillStyle="#b522a8";
		ctx.fill();
		$('.hotmemes').hide();
		$('.trendingmemes').show();
	...
	$('#freshmemes').click(function(){
		...
		ctx.clearRect(0,0,canvas.width,canvas.height);
		ctx.beginPath();
		ctx.rect(0,0,canvas.width-$(this).width()-24,canvas.height);
		ctx.rect(canvas.width-$(this).width()-24,4,$(this).width()+13,canvas.height);
