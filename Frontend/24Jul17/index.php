...
<div class="tabs">
	...
	if(isset($_SESSION['id'])){
		...
		<canvas id="tab-bottom" width="600" height="5"></canvas>
	<?php
	}else{
		?>
	...
	if(isset($_SESSION['id']))
	{
		...
		while($row=mysqli_fetch_assoc($result)){
			...
			if($viewingStatus==0)
			{
				...
				<a href="<?php echo $nL; ?>" class="notif-link" id="notification<?php echo $notificationId; ?>">	
				    <div class="notif">
						<img src="<?php echo $ppL; ?>" class="notif-dp">
