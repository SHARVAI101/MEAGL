...
if(isset($_SESSION['id']) && isset($_GET['id']) && $_GET['id']==$_SESSION['id']){
	...
	<div class="invitation">
		...
		<p class="score-prompt">Actually, it is more than just fun. You get 40 points if they register!</p>	
...
<?php
	if((isset($_GET['id']) && isset($_SESSION['id']) && $_GET['id']==$_SESSION['id'])){
		//only visible if the user is viewing his own profile
	?>
	<a href="#notifications-tab" id="notif-tab">Notifications</a>
	<?php
	}
	else
	{
		...
		<div class="inner-tab-content">
			<div class="inner-tab" id="subscribedchannels">
    			...
    			while($row=mysqli_fetch_assoc($result)){
    				...
    				echo '<p><a href="userprofile.php?id='.htmlentities($channelId).'">'.$channelName.'</a></p>';
    				echo '<p>Subscribers: '.$numberofSubscribers.'</p>';
    				echo '<hr>';
    			}
			...
			<div class="inner-tab" id="subscribedcategories">
    			...
    			if (!empty($allmemes_categories)) {
	    			...
	    			echo '<p class="error-message">No meme categories subscribed to yet!</p>';
	    		}
    			?>
			</div>
			<div class="inner-tab" id="allcontent">
    			...
    			if (!empty($allmemes)) {
	    			...
	    			echo '<p class="error-message">No meme channels or meme categories subscribed to yet!</p>';
	    		}
    			?>
			</div>
			<?php
