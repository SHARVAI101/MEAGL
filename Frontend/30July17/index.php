...
if(isset($_SESSION['id'])){
	...
	<div class="tabs">
		...
		<canvas id="tab-bottom" width="600px" height="5"></canvas>
<?php
}else{
	?>
	<div class="tabs">
		<a id="trendingmemes" class="sign-out-trend" href="#trending" style="color: #aaa;border-radius:3px;top:3.5px">Trending</a>
		<a id="freshmemes" class="sign-out-fresh" href="#fresh" style="color: #aaa;border-radius:3px;top:3.5px;">Fresh</a>	
			...
			if($viewingStatus==0)
			{
				...
				<a href="<?php echo htmlentities($nL); ?>" class="notif-link" id="notification<?php echo htmlentities($notificationId); ?>">	
				    <div class="notif">
					    ...
					    <p class="notif-text"><?php echo htmlentities($notification); ?></p>							
					</div>
				</a>
