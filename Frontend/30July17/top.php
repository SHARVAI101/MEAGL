...
<body style="background-color:#fefefe" >	
    ...
    <div class="top-nav container-fluid">
        <nav>
        	...
        	?>
            <a href="index.php"><img class="logo-style" src="logo/m.png"></a>
            ...
            <div class="search-box" id="search-box">
                <form class="searchBarForm">
                    <input type="text" placeholder="Search users" class="search form-control">                   
                </form>
            ...
            <div class="wrapper">
                ...
                <?php
                    ...
                    if($current_page=='/meagl.com/signup.php?lastpage=uploadmeme.php'){
                        ...
                        //echo $current_page;
                        echo '<li style="display:inline" class="sign-in"><a href="signup.php">Sign In / Sign Up</a></li>';
                    }
                }
                ?>
        ...
        <div class="mobi-options">
            <h4  class="mobi-option"><a href="uploadmeme.php">Upload</a></h4>
            <h4 class="mobi-option" id="mobi-notif">Notifications</h4>
            <a href="userprofile.php?id=<?php echo htmlentities($_SESSION['id']); ?>"><h4 class="mobi-option">My Profile</h4></a>
            <a href="editPersonalInfo.php"><h4 class="mobi-option">Settings</h4></a>
        ...
        <div class="user-options">
            ...
            <a href="logout.php" class="user-option-link outbutton"><h4 class="user-option">Sign out</h4></a>
