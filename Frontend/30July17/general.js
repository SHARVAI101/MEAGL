...
$(document).ready(function(){
  $('.subscribe-button').mouseover(function() {
    ...
    $('.subscribers').css('border-left','none');
  });
});
$(document).ready(function(){
  $('.subscribe-button').mouseout(function() {
    $(this).css("color", "white");
    $('.subscribers').css('border-left','solid 1px white');
  });
});
//
$(document).ready(function(){
            ...
            ctx.beginPath();
                ...
                $(window).scroll(function(){
                    ...
                    if (scrollYpos > tOffset - sHeight) {
                        ...
                        if($('.notifications-column').width()>350)
                        {
