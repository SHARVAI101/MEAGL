...
if(isset($_SESSION['id'])){
	...
	<a href="signup.php">
		<span class="sign-up-advert index-group-display">
			...
			<p class="sign-up-p"> Sign up to amazingness! Sign up to Meagl.</p>
...
<?php
	...
	<div class="tabs">
		...
		<a id="recommendedmemes" class="sign-out-recom" href="#recommended" style="color: #aaa;border-radius:3px;top:3.5px;position:relative;left:80px;border:none;background-color:#eee;padding:5px 10px 5px 10px;letter-spacing:1px">Recommended</a><!--style this boi-->
...
<div class="tab-content" id="tabs"> 
	...
	{//style this boi
		...
		<div class="tab recommendedmemes" id="recommended">
			<?php
			echo '<p class="error-message" style="text-align:center;margin-top:30px">Here, memes according to your interests are displayed.</p>';
