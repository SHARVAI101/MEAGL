...
?>
	...
	<div class="prof-pic-update">
		...
		<img id="prof-pic" src="users/sharvai/profilepicture/profilePicture.jpg">
		<form action="" id="updateProfilePicture" method="post" enctype="multipart/form-data">		
			<input type="file" id="profilePicture" name="profilePicture"class="filestyle" data-buttonName="settings-select-pic btn" data-icon="false" data-buttonText="Select a Picture" data-input="false" ><br>		
