...
//here, receiver is the person who is accepting the friend request and sender is the one who has sent him the friend request

$sql="UPDATE friends_table set relation=1 WHERE sender_user_id='$sender' AND receiver_user_id='$receiver'";
...
$notificationString=$receiverUsername.' accepted your friend request!';
$notificationLink='userprofile.php?id='.$receiver;
